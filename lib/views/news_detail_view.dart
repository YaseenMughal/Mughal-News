...
class NewsDetailView extends StatefulWidget {
  final String? image, title, date, description, author, content, source, listType;
  const NewsDetailView({super.key, this.image, this.title, this.date, this.description, this.author, this.content, this.source, this.listType});
              ...
              child: Stack(
                children: [
                  InkWell(
                    ...
                    child: Hero(
                      tag: widget.listType == 'first' ? 'first_list_image' : 'second_list_image',
                      child: CachedNetworkImage(
                        ...
                        errorWidget: (context, url, error) => Icon(Icons.error_outline, color: AppColor.redColor),
                      ),
                    ),
                  ),
                  Positioned(
